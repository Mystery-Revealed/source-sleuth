...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'source-sleuth', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[source-sleuth] listening on :${config.port} — sessions live in memory only`);
});
